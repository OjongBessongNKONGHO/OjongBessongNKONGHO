...
Data Engineering Intern at Boston University School of Medicine. Final-year BSc Computer Science & Engineering, DSTI School of Engineering, Paris. Pre-admitted to the MSc Data Engineering for AI, March 2027.
...
Open to Data Engineering or Backend Engineering roles — internship from January 2027, apprenticeship from March 2027.
...
Whole-slide pathology images are gigapixel-scale and cannot be fed directly into any model. This pipeline segments the tissue, extracts patches, and runs them through UNI2-h and TITAN to produce feature embeddings for downstream lung cancer classification. Runs on BU's HPC cluster with SLURM job submission. Config-driven so lab members edit a YAML file instead of memorizing CLI flags. Images are downloaded in batches and deleted after extraction to stay within storage limits. Downstream model training via Patho-Bench. Python, SLURM, HPC.
...
Python, SQL, FastAPI, SQLAlchemy 2.0 async, Pydantic v2, fastavro, Kafka, Spark, Airflow, dbt, Delta Lake, DuckDB, Prometheus, Grafana, AWS, Terraform, Docker, GitHub Actions, PostgreSQL, psycopg3, SLURM, HPC, TRIDENT, Patho-Bench

Currently Data Engineering Intern at Boston University School of Medicine, deploying computational pathology pipelines on a Linux HPC cluster. Previously Data Analyst Intern at the same lab, processing bulk RNA-seq datasets in R. Reproducibility requirements were strict enough that cutting corners showed up immediately in the results.

📍 Paris · nkongho.ojong-bessong@edu.dsti.institute · [LinkedIn](https://www.linkedin.com/in/nkongho-ojong)
